<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="signup.aspx.cs" Inherits="ShopManager.WebForm2" %>
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col-8">
                        <center>
                           <div class="form-group ">
                              <asp:Button class="btn btn-success btn-block btn-sm" ID="btnSignUp" runat="server" Text="Đăng Ký" Width="714px" OnClick="btnSignUp_Click" />
                           </div>
                        </center>
                     </div>
                  </div>
