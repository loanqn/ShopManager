    ...
    public partial class WebForm2 : System.Web.UI.Page
    {
        ...
        protected void SignUpMember()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("INSERT INTO user_master_tbl" +
                    "(full_name, dob, contact_no, email, state, city, pincode, full_address, user_id, password)" +
                    " values(@full_name, @dob, @contact_no, @email, @state, @city, @pincode, @full_address, @user_id, @password)", con);
